...
cdef class BaseBoard:
    ...
    cdef unsigned long long occupied_co[2]
    cdef unsigned long long pawns
    cdef unsigned long long knights
    cdef unsigned long long bishops
    cdef unsigned long long rooks
    cdef unsigned long long queens
    cdef unsigned long long kings
    cdef unsigned long long castling_rights
    cdef bint promoted
    cdef bint occupied
    cdef bint chess960
    cdef bint turn
    cdef PseudoLegalMoveGenerator pseudo_legal_moves
    cdef LegalMoveGenerator legal_moves
    cdef object move_stack
    cdef object stack
    cdef object ep_square
